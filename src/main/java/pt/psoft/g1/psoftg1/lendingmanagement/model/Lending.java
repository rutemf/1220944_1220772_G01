...
public class Lending {
    @Transient
    static final int FINE_VALUE_PER_DAY_IN_CENTS = 300;    //TODO: Move this to a properties file

    @Transient
    static final int MAX_DAYS_PER_LENDING = 15;    //TODO: Move this to a properties file
