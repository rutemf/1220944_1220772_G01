    ...
    class ReaderController {
        ...
        public ResponseEntity<Object> createReader(@RequestBody CreateReaderRequest readerRequest) {
            ...
            try {
                ...
                pt.psoft.g1.psoftg1.readermanagement.api.ReaderController.ErrorResponse responseBody = new pt.psoft.g1.psoftg1.readermanagement.api.ReaderController.ErrorResponse("Error creating reader: " + e.getMessage());
